...
Использование:
  ...
  python3 auto_commit.py --repo /path/to/repo
...
def run(cmd, cwd=None):
    # git всегда отдаёт UTF-8; без явной кодировки Windows читает вывод как cp1252
    # и падает на первом же не-ASCII символе в сообщениях коммитов или путях.
